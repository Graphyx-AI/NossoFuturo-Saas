...
export function getSupabaseConfigErrorMessage() {
  return 'Supabase não configurado: defina NEXT_PUBLIC_SUPABASE_URL e NEXT_PUBLIC_SUPABASE_ANON_KEY (ou NEXT_PUBLIC_SUPABASE_KEY) no ambiente e reinicie o npm run dev.';
}
